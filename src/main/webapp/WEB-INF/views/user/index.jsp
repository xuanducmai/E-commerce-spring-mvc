...
-->
		<div class="well well-small">
			...
			<div class="row-fluid">
				<div id="newProductCar" class="carousel slide">
					<div class="carousel-inner">
						<c:if test="${ products_new.size() > 0 }">
							<div class="item active">
								<ul class="thumbnails">

									<c:forEach var="item" items="${ products_new }"
										varStatus="loop">
										<li class="span3">
											<div class="thumbnail">
												<a class="zoomTool"
										...
										<c:if
											test="${ (loop.index + 1) % 4 == 0 || (loop.index + 1)  == products_new.size() }">
								</ul>
							</div>
	...
	-->
		<div class="well well-small">
			...
			<div class="row-fluid">
				...
				<c:if test="${ products_highlight.size() > 0 }">
					<ul class="thumbnails">
						<c:forEach var="item" items="${ products_highlight }" varStatus="loop">
							<li class="span4">
								<div class="thumbnail">
									<a class="zoomTool"
										href="chi-tiet-san-pham/${ item.id_product }"
		...
		<hr>
		<div class="well well-small">
			<a class="btn btn-mini pull-right" href="/ClothesShop/tat-ca-san-pham">Xem thêm <span
