...
<div class="row">
	<div class="span12">
    <ul class="breadcrumb">
		<li><a href="http://localhost:8080/ClothesShop/">Trang chủ</a> <span class="divider">/</span></li>
              ...
              <tbody>
				...
				<c:forEach var="item" items="${ Cart }">
					<tr>
	                  ...
	                  <td>
	                  	<button data-id="${ item.key }" class="btn btn-mini btn-warning edit-cart" type="button">
