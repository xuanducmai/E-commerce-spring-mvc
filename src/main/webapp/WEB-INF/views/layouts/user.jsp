		...
		<div class="topNav">
			<div class="container">
				<div class="alignR">
					...
					<a class="active" href="/ClothesShop/"> <span class="icon-home"></span> Trang chủ</a>
					...
					<a href="http://localhost:8080/ClothesShop/contact"><span class="icon-envelope"></span> Liên hệ với chúng tôi</a> 
