...
<section class="our_client">
	...
	<div class="row">
		<div class="span2">
			<a href="#"><img alt=""
				src="<c:url value="/assets/user/img/gucci.png"/>"></a>
		</div>
		<div class="span2">
			<a href="#"><img alt=""
				src="<c:url value="/assets/user/img/adidas.png"/>"></a>
		</div>
		<div class="span2">
			<a href="#"><img alt=""
				src="<c:url value="/assets/user/img/hermes.png"/>"></a>
		</div>
		<div class="span2">
			<a href="#"><img alt=""
				src="<c:url value="/assets/user/img/lv.png"/>"></a>
		</div>
		<div class="span2">
			<a href="#"><img alt=""
				src="<c:url value="/assets/user/img/chanel.png"/>"></a>
		</div>
		<div class="span2">
			<a href="#"><img alt=""
				src="<c:url value="/assets/user/img/nike.png"/>"></a>
		</div>
	</div>
</section>
